...
- **Targets**: eight hot-air balloons drifting along the route, two blimps cruising it end to end, a UFO zig-zagging over the desert (its ring of lights alternates green/red), five boats circling the great lake, four flocks of birds wheeling low over the farmland and plains, five kites bobbing on strings, and eight bullseye discs on poles. A missile pops them (balloons, the UFO and discs add a sparkle burst; birds and kites a soft puff); they come back 6-10 s later. Flying into one is a mid-air like the traffic planes. The freight train's cars are shootable too -- a hit car leaves the train until it loops round.
