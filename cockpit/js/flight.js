...
function update(dt) {
  ...
  if (state.exploding) {
    if (state.vp.rocket) { el.slowBtn.classList.add("hidden"); el.fastBtn.classList.add("hidden"); el.missileBtn.classList.add("hidden"); el.skipBtn.classList.add("hidden"); el.stageBtn.classList.add("hidden"); el.satBtn.classList.add("hidden"); el.chuteBtn.classList.add("hidden"); el.roverBtn.classList.add("hidden"); el.hatchBtn.classList.add("hidden"); }
