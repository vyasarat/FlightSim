...
["hud", "pillarL", "pillarR", "brow", "dash", "asiDial", "aiDial", "altDial",
 ...
 "screenVehicle", "screenDir", "screenDest", "progressStrip", "viewBtn", "gearBtn", "slowBtn", "glideGuide", "skipBtn", "fastBtn", "missileBtn", "aimMarker", "vehBtn", "alarm", "wingman", "camBtn", "photo", "photoImg", "flash", "stageBtn", "satBtn", "chuteBtn", "reentryGlow", "roverBtn", "hatchBtn", "bigNum", "bucketBtn", "catBtn", "droneBtn", "heliUpBtn", "heliDownBtn", "heliTarget", "magnetBtn", "washBtn", "cannonBtn", "garageBtn", "ejectBtn", "ejectVeil", "hornBtn", "speedBtn", "menuBtn", "lockBtn", "hopBtn"].forEach(id => {
